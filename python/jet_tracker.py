...
#    tr_array = var_tr_data[0]
    ...
    for hi in range(1,int(np.floor(height_y[ind]))+1):
        ...
        if jet_sides_index1==None:
            ...
            if testing == True:
                plt.scatter(jet_sides_index1[1],jet_sides_index1[0],
                            s=30, color='blue')
                plt.scatter(jet_sides_index2[1],jet_sides_index2[0],
                            s=30, color='blue')            
    if testing == True:
        # testing
        cmap = 'gray'
...
if plotting_on == True:
    ...
    #    print(hi)
        ...
        idx_side = np.where(dumma_array_for_idxs==(hi/cm_to_Mm))
