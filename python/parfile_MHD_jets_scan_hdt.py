...
sav_loc = '/shared/mhd_jet1/User/smp16fm/j/hdt'
...
#time_driver = ['50', '125', '200']
#bb2 = ['50'] 
#amplitude =  ['40', '60']

time_driver = ['225', '250', '275', '300']
bb2 = ['50'] 
amplitude =  ['40','45','50','60']

qsub_names_list = []
qsubpy_names_list = []
for td in range(len(time_driver)):
    template['&sim_parameters']['driver_time='] = time_driver[td]+'.0d0'    
    for b in range(len(bb2)):
        template['&sim_parameters']['bb2='] = bb2[b]+'.0d0'
        for amp in range(len(amplitude)):            
            par_name = 'jet_P'+time_driver[td]+'_B'+bb2[b]+'A_'+amplitude[amp]
            par_path =  '/hdt/P'+time_driver[td]+'/B'+bb2[b]+'/A'+amplitude[amp]
            sav_path = '/P'+time_driver[td]+'/B'+bb2[b]+'/A'+amplitude[amp]
            template['&sim_parameters']['driver_amplitude='] = amplitude[amp]+'.0d5'
