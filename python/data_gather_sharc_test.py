...
data_save = True
data_save_dir = path_2_shared_drive+'/python/hdt_testing/'
td_plotting = True
td_plot_root_folder =path_2_shared_drive+'/python/td_plots_testing/'
...
#    full_paths = glob.glob(path+'/jet_'+path_parts[0] + 
#                           '_'+path_parts[1] + 
#                           '_'+path_parts[2]+'*.vtu')
    # skip first step as no value
#    full_paths = full_paths[1:]
#    print('full_paths 1', full_paths)
    # testing
    full_paths = full_paths[102:106]
    print('full_paths 2', full_paths)
   
    sub_data_1 = []
    sub_data_2 = []
    physical_time = []
    print('path_parts', path_parts)
    print(path+'/jet_'+path_parts[0]+'_'+path_parts[1]+'*.vtu')
...
#        print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1'+data_save_dir+jet_name, testc)
        ...
        df.to_pickle(data_save_dir+jet_name+'/'+jet_name+'max_h.pickle')
        df_bd.to_pickle(data_save_dir+jet_name+'/'+jet_name+'big_data.pickle')
        
        df.to_csv(data_save_dir+jet_name+'/'+jet_name+'max_h_test.csv')
        df_bd.to_csv(data_save_dir+jet_name+'/'+jet_name+'big_test.csv')
...
## how to read pickels
df_read_test = pd.read_pickle(data_save_dir+jet_name+'/'+jet_name+'big_data.pickle')
print(df_read_test['dfs'][0])
