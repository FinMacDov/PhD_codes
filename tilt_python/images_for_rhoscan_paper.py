...
#path_2_files = ['/j/B/P300/B60/A20/','/j/B/P300/B60/A80/','/j/B/P300/B20/A60/']
#file_names = ['jet_P300_B60A_20_','jet_P300_B60A_80_','jet_P300_B20A_60_']

#path_2_files = ['/j/B/P300/B80/A60/','/j/B/P50/B60/A60/','/j/B/P200/B60/A60/']
#file_names = ['jet_P300_B80A_60_','jet_P50_B60A_60_','jet_P200_B60A_60_']

#path_2_files = []
#file_names = []

path_2_files = ['/j/B/P300/B80/A60/','/j/B/P300/B20/A60/','/j/B/P300/B60/A80/',
                '/j/B/P300/B60/A20/','/j/B/P200/B60/A60/','/j/B/P50/B60/A60/']
file_names = ['jet_P300_B80A_60_','jet_P300_B20A_60_','jet_P300_B60A_80_',
              'jet_P300_B60A_20_','jet_P200_B60A_60_','jet_P50_B60A_60_']
# constants
unit_length = 1e9  # cm
...
for ind, ti in enumerate(time_stamps):
    ...
    for ax, im_title in zip(grid2, ['B = 80 G',
                                    'B = 20 G',
                                    'A = 80 $km ~s^{-1}$',
                                    'A = 20 $km ~s^{-1}$',
                                    'P = 200 s',
        ...
        t.patch.set_ec("none")
        t.patch.set_alpha(1)
    F.savefig('sj_paper/movie/pscan/pscan_for_movie'+offset+'.png', bbox_inches='tight')
    F.clf()
plt.close()
