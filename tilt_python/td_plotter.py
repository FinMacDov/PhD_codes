...
save_folder = path_2_shared_drive+'tilt_python/sj_td_plot_figs/'
if save_figs==True:
...
for fname in file_names:
    ...
    save_folder = path_2_shared_drive+'tilt_python/sj_td_plot_figs/'+join_name+'/'
    if save_figs==True:
        Path(save_folder).mkdir(parents=True, exist_ok=True)
    path_td_data = 'td_plots_data_sj/'+fname
