...
path_2_files = np.empty(sim_nbs, dtype='U40')
file_names = np.empty(sim_nbs, dtype='U30')

#path_2_files = ['/j/2D/P300/T60/']
#file_names = ['jet_P300_T60_']
counter = 0
for nb_dt in range(len(driver_time)):
 ...
 #               print(counter)
                path_2_files[counter] = path_root+driver_time[nb_dt]+'/'+mag_str[nb_mag]+'/'+Amp[nb_amp]+'/'+tilt[nb_tilt]+'/'
                file_names[counter] = 'jet_'+driver_time[nb_dt]+'_'+mag_str[nb_mag]+'_'+Amp[nb_amp]+'_'+tilt[nb_tilt]+'_'
                #        print(driver_time[nb_dt], tilt[nb_tilt], path_2_files[counter], file_names[counter])
                counter += 1
# vpn timed out 
n = 0
path_2_files = path_2_files[n:]
